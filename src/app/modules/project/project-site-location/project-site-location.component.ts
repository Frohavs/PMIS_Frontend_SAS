...
@Component({
  selector: 'app-project-site-location',

  templateUrl: './project-site-location.component.html',
  styleUrl: './project-site-location.component.scss'
})
export class ProjectSiteLocationComponent implements OnInit, AfterViewInit, OnDestroy{
  projectId: number;

  Add_text: string = 'new order';
  Search_text: string = 'search order';
  dataList: any[] = [];
  totalCount: number;
  pagesCount: number[] = [];
  selected = 1;
