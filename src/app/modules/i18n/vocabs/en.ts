...
export const locale = {
  ...
  data: {
    ...
    DASHBOARD_PAGE: {
      ...
      REVENUE: 'Total Projects values',
      ACTUAL_REVENUE: 'Approved Invoices',
      USERS_OVERVIEW: 'Users Overview',
      TOTAL_USERS: 'Total Users',
      ACTIVE_TODAY: 'Active Today',
      DRAFT: 'Delivery Process',
      DRAFTU: 'Hold Users',
      COMPANIES_VENDORS: 'Companies / Vendors',
      REGISTERED_COMPANIES: 'Registered Companies',
      ACTIVE_VENDORS: 'Contractors',
      PENDING_APPROVAL: 'Consultant',
      INVOICE_TREND: 'Invoice VS Cashflow',
      ...
      VENDORS_PENDING_APPROVAL: 'Vendors Pending Approval',
      USERS_PENDING_ROLE_ASSIGNMENT: 'Users Pending Role Assignment',
      DETAILED_PROJECT_ISSUES: 'Detailed Project Issues',
      STATUS: 'Status',
      AGENCY: 'Agency',
      ...
      AGENCY_3: 'Agency 3',
      AGENCY_4: 'Agency 4',
      ISSUE_1: 'Development of Commercial Project (2346) in Riyadh Area - 2019 - 4 yrs',
      ISSUE_2: 'New Infrastructure Upgrade (2484) in Riyadh - 3 yrs',
      ISSUE_3: 'Construction of New Residential Buildings (2990) in Al Kharj - 3 yrs',
      ISSUE_4: 'Road Expansion (2599) in Jeddah City - 32 months',
      ISSUE_5: 'Airport Terminal Renovation (3245) in Riyadh - 2.5 yrs',
      PROJECTS_STATUS_OVERVIEW: 'Projects Status Overview',
      ON_TRACK: 'On Track',
      NEAR_DELAY: 'Near Delay',
      CRITICAL: 'Critical',
      PROJECT_LOCATIONS_MAP: 'Project Locations Map'
    },
    COMPANY: {
      ID: 'ID',
      TITLE: 'Company',
